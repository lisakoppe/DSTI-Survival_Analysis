...
1. Comparison between 2 groups of patients based on underlying lung disease
Among total 85 patients with emphysema, 43 of them died with 40% chance of death at 82 months.
Among total 21 patients with ILA, 18 of them died with 5% chance of death at 21.5 months.
Among total 292 patients without underlying lung disease, 111 of them died.
Logrank test result shows a significant difference in survival between these groups of patients (p=4e-11).


2. Comparison between 2 groups of patients based on their age
Among total 90 patients below the age of 60, 26 diead .
Among total 308 patients above the age of 60, 146 diead with 63 % Chance of death at 82 months.
Logrank test result shows a significant difference in survival between these groups of patients (p=8e-04 ).


3. Comparison between 2 groups of patients based on central lung SCC size of tumor
Among total 73 patients with tumor size T1, 21 diead .
Among total 252 patients with tumor size T2, 105 diead .
Among total 58 patients with tumor size T3, 37 diead with  24 % chances of death at 39 months.
Among total 15 patients with tumor size T4, 9 diead.
Logrank test result shows a significant difference in survival between these groups of patients (p= 3e-0 ).


4. Comparison between 2 groups of patients based on cN when nearby lymph nodes are involved
Among total 284 patients with N0 Nearby lymph nodes that are involved, 114 diead .
Among total 68 patients with N1 Nearby lymph nodes that are involved, 27 diead .
Among total 39 patients with N2 Nearby lymph nodes that are involved, 27 diead with  25 % chances of death at 38 months.
Among total 7 patients with N0 Nearby lymph nodes that are involved, 4 diead with  18 % chances of death at 31 months.
Logrank test result shows a small difference in survival between these groups of patients (p= 0.002 ).


5. Comparison between 2 groups of patients based on peripheral lung SCC size of tumor
Among total 72 patients with pT1 Peripheral Lung SCC size of Tumor, 23 of them died.
Among total 240 patients with pT2 Peripheral Lung SCC size of Tumor, 101 of them died with 82% chance of death at 103.3 months.
Among total 78 patients with pT3 Peripheral Lung SCC size of Tumor, 43 of them died with 37% chance of death at 47.4 months.
Among total 8 patients with pT4 Peripheral Lung SCC size of Tumor, 5 of them died with 30% chance of death at 74.9 months.
Logrank test result doesn't show a significant difference in survival between these groups of patients (p=0.04).


6. Comparison between 2 groups of patients based on pN when nearby lymph nodes are involved
Among total 246 patients with pN0 when nearby lymph nodes are involved, 93 of them died.
Among total 95 patients with pN1 when nearby lymph nodes are involved, 41 of them died.
Among total 53 patients with pN2 when nearby lymph nodes are involved, 35 of them died with 30% chance of death at 37.5 months.
Among total 4 patients with pN3 when nearby lymph nodes are involved, 3 of them died with 16% chance of death at 24.2 months.
Logrank test result shows a significant difference in survival between these groups of patients (p=5e-05).


7. Comparison between 2 groups of patients based on pM when distant metastasis are involved
Among total 394 patients with pM0 when distant metastasis are involved, 168 of them died with 84% chance of death at 103.3 months.
Among total 4 patients with pM1b when distant metastasis are involved, all of them died with 3% chance of death at 5.35 months.
Logrank test result shows a significant difference in survival between these groups of patients (p=8e-05).


8. Comparison between 2 groups of patients based on the observation of metastasis after surgery
Among total 238 patients without observed metastasis, 73 of them died.
Among total 160 patients with observed metastasis, 99 of them died with 38% chance of death at 44.7 months.
