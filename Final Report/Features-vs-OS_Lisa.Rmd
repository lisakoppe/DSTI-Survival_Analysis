...
The Logrank test result doesn't show a significant difference in survival between groups of patients according to the peripheral lung SCC size of tumor (p-value=0.04).
We then reject the use of the pT covariate.
