...
Check null value and data classification 
...
3. OS
   = overall survival: interval between the date of diagnosis and date of death (by any cause)
...
17. Smoking_state
18. FEV1_FVC
    = pulmonary function test: forced expiratory volume in a second / forced vital capacity
19. CEA
    = serum carcinoembryonic antigen (tumor marker)
20. op_type
21. meta
    = metastasis observed


# Part 1: Test relationship between radiologic/clinicopathologic features and death (Not consider survival duration)
