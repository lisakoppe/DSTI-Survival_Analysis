...
>>>>>>> 770dccbc5173bfbeed1ff9568a171f29e55bcbdf
...
```{r}
fit.Necrosis <- survfit(Surv(OS, death)~Necrosis, data=lungSCC)
fit.Necrosis
```


```{r}
ggsurvplot(fit.KM_Necrosis,
           legend = "bottom",
           conf.int = TRUE,
           linetype = "strata",
           legend.title = "Observation of Necrosis",
           xlab = "Months",
           ylab = "Survival probability")
```
