...
2. The negative value of estimate coefficient of LocationInvisible indicates that invisible lung cancer has negative correlation with risk of death. 
3. Odds of patient with invisible lung cancer is lower than odds of central lung cancer patients.
To see the odds ratio between these 2 condition, we have to exponent this coefficients (see belows).
4. The presence of peripheral lung cancer has positive relationship with death.
5. Odds of peripheral lung cancer is higher than that of central lung cancer
...
```
Interpretation:
The p-value is way lower than the significant level of 5% (p-value = 1.61e-10) the variables are closely dependent. Data is sufficient to prove that the observation of metastasis after surgery increases the risk leading to death.
We can then reject the null hypothesis.

The odds ratio (3.8195) suggests that patients with observed metastasis after surgery have approximately 282% higher risk of death than patients without any metastasis observed.
95% confidence interval ranges from 2.46 to 5.96.
...
```
Interpretation:
1. The coefficient is positive (1.39) which means that there is a positive association between the lymph node ratio and the risk of death.
...
```
Interpretation:
1. pT3 tumor size shows significantly positive relationship with the risk of death with p-value 0.004.
...
```
Interpretation:
1. The risk of death of patients who have a tumor of pT2 size type is 54% higher than for patients whose tumor has pT1 size type.
2. The risk of death of patients who have a tumor of pT3 size type is 160% higher than for patients whose tumor has pT1 size type.
3. The risk of death of patients who have a tumor of pT4 size type is 253% higher than for patients whose tumor has pT1 size type.
...
```
Interpretation:
1. pN2 tumor size shows a highly significant positive relationship with the risk of death with p-value 0.0002.
...
2. The risk of death of patients who have a tumor of pN2 size type is 221% higher than for patients whose tumor has pN0 size type.
3. The risk of death of patients who have a tumor of pN3 size type is 396% higher than for patients whose tumor has pN0 size type.
...
```
Interpretation:
1. There is no significant relationship between the pM tumor size and the prediction of death status (p-value = 0.98).
